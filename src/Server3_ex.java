...
public class Server3_ex {
    ...
    private static final String SERVER_HOST = "192.168.56.1";// Server3's port
    ...
    public static void main(String[] args) throws IOException {
        ...
        // Ping other servers
        new PingThread("192.168.56.1", 5001).start(); // Ping Server1
        new PingThread("192.168.56.1", 5002).start(); // Ping Server2
